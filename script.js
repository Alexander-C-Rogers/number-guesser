...
const compareGuesses = (humanGuess, computerGuess, targetNumbers) => getAbsoluteDistance(humanGuess, targetNumbers) <= getAbsoluteDistance(computerGuess, targetNumbers) ? true : false ;
